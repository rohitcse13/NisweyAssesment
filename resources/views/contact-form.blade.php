...
<body class="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4 py-6">

    <div class="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-semibold text-center text-gray-700">Contact Form Upload</h2>
        ...
        <form id="contact-form" data-url="{{ route('submit.form') }}" class="mt-4">
            ...
            <button type="submit" class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 rounded-lg mt-4">
                Submit Form
            </button>
        </form>
        ...
        <form id="xml-upload-form" data-url="{{ route('upload.xml') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4 text-center">
                ...
                <p id="file-name" class="text-gray-600 mt-2 text-sm"></p>
            </div>
    ...
    <div class="w-full max-w-4xl bg-white p-6 rounded-lg shadow-lg mt-6 overflow-x-auto">
    ...
    <div id="updateModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center px-4">
